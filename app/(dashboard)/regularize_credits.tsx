    ...
    <SafeAreaView style={styles.root}>
      <View>
        ...
        <View style={styles.circle}>
          <Image source={images.sentiment_sad} style={styles.checkIcon} />
        </View>
        <Text style={styles.title}>¡Tenes que regularizar{'\n'}tu crédito!</Text>
...
export default RegularizeCreditsScreen;
