...
import { styles } from './OTPInputText.styles';
import { OTPInputTextProps, OTPInputTextRef } from './OTPInputText.types';
import { VerticalStick } from './VerticalStick';
import { useOtpInput } from './useOtpInput';

export const OTPInputText = forwardRef<OTPInputTextRef, OTPInputTextProps>((props, ref) => {
  const {
              ...
              <Pressable
                ...
                {isFocusedInput && !hideStick ? (
                  ...
                  <Text style={[styles.codeText, pinCodeTextStyle]}>
                    {char && secureTextEntry ? '•' : (char || '').toUpperCase()}
                  </Text>
                )}
              </Pressable>
            );
