...
interface PointsQuestionsScreenProps {
  navigation?: any;
}

const PointsQuestionsScreen = ({ navigation }: PointsQuestionsScreenProps) => {
  const scrollViewRef = useRef<ScrollView>(null);
  return (
    <View style={styles.container}>
      <ScrollView style={styles.scrollView} ref={scrollViewRef}>
        <View style={styles.back}>
          <Pressable onPress={() => navigation.navigate('Profile')} style={styles.btnBack}>
